...
xcodebuild clean build archive -scheme "ColorPaletteCodable" -destination 'generic/platform=macOS,variant=Mac Catalyst' -quiet
xcodebuild test -scheme "ColorPaletteCodable" -destination 'platform=macOS,variant=Mac Catalyst' -quiet
