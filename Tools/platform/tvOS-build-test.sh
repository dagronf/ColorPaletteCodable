...
xcodebuild clean build archive -scheme "ColorPaletteCodable" -destination 'generic/platform=tvOS' -quiet
xcodebuild test -scheme "ColorPaletteCodable" -destination 'platform=tvOS Simulator,name=Apple TV' -quiet
