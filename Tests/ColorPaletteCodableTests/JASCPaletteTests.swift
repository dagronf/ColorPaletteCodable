...
class JASCPaletteTests: XCTestCase {
	...
	func testMultipleExtensionSupport() throws {
		...
		XCTAssertEqual(palette.colors[1], try PAL.Color(r: 37, g: 37, b: 37))
		XCTAssertEqual(palette.colors[254], try PAL.Color(r: 255, g: 207, b: 126))
		XCTAssertEqual(palette.colors[255], try PAL.Color(r: 255, g: 218, b: 150))
		...
		XCTAssertEqual(palette2.colors[1], try PAL.Color(r: 37, g: 37, b: 37))
		XCTAssertEqual(palette2.colors[254], try PAL.Color(r: 255, g: 207, b: 126))
		XCTAssertEqual(palette2.colors[255], try PAL.Color(r: 255, g: 218, b: 150))
	}
}
