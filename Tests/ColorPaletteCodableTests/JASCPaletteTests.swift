...
class JASCPaletteTests: XCTestCase {
	...
	func testMultipleExtensionSupport() throws {
		...
		XCTAssertEqual(palette.colors[0], try PAL.Color(rgbHexString: "#000000", colorType: .global))
		XCTAssertEqual(palette.colors[1], try PAL.Color(r255: 37, g255: 37, b255: 37))
		XCTAssertEqual(palette.colors[254], try PAL.Color(r255: 255, g255: 207, b255: 126))
		XCTAssertEqual(palette.colors[255], try PAL.Color(r255: 255, g255: 218, b255: 150))

		let data = try PAL.Coder.PaintShopPro().encode(palette)
		let palette2 = try PAL.Palette.Decode(from: data, fileExtension: "psppalette")
		XCTAssertEqual(256, palette2.colors.count)
		XCTAssertEqual(palette2.colors[0], try PAL.Color(rgbHexString: "#000000", colorType: .global))
		XCTAssertEqual(palette2.colors[1], try PAL.Color(r255: 37, g255: 37, b255: 37))
		XCTAssertEqual(palette2.colors[254], try PAL.Color(r255: 255, g255: 207, b255: 126))
		XCTAssertEqual(palette2.colors[255], try PAL.Color(r255: 255, g255: 218, b255: 150))
	}
}
