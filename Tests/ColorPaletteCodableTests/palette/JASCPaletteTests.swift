...
class JASCPaletteTests: XCTestCase {
	...
	func testMultipleExtensionSupport() throws {
		...
		XCTAssertEqual(palette.colors[0], try PAL.Color(rgbHexString: "#000000", format: .rgba, colorType: .global))
		...
		XCTAssertEqual(palette2.colors[0], try PAL.Color(rgbHexString: "#000000", format: .rgba, colorType: .global))
