...
final class RIFFSwatchesTests: XCTestCase {
	func testBasic() throws {
		...
		XCTAssertEqual(palette.colors[0], try PAL.Color(r255: 0, g255: 0, b255: 0))
		XCTAssertEqual(palette.colors[1], try PAL.Color(r255: 157, g255: 157, b255: 157))
		XCTAssertEqual(palette.colors[14], try PAL.Color(r255: 49, g255: 162, b255: 242))
		XCTAssertEqual(palette.colors[15], try PAL.Color(r255: 178, g255: 220, b255: 239))
	}
