...
final class CommonTests: XCTestCase {
	...
	func testUnknownFormat() throws {
		...
		XCTAssertThrowsError(try PAL.Palette.Create(from: txtFile))
	}
	...
	func testColors() throws {
		...
		let reloaded = try PAL.Coder.ASE().create(from: aseData)
